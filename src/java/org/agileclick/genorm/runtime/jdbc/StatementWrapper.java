...
public class StatementWrapper implements Statement
	...
	// JDBC 4.2
		...
		public long[] executeLargeBatch() throws SQLException {
			return m_statement.executeLargeBatch();
		}

		public long executeLargeUpdate(String sql) throws SQLException {
			return m_statement.executeLargeUpdate(sql);
		}

		public long executeLargeUpdate(String sql, int autoGeneratedKeys)
				throws SQLException {
			return m_statement.executeLargeUpdate(sql, autoGeneratedKeys);
		}

		public long executeLargeUpdate(String sql, int columnIndexes[]) throws SQLException {
			return m_statement.executeLargeUpdate(sql, columnIndexes);
		}

		public long executeLargeUpdate(String sql, String columnNames[])
				throws SQLException {
			return m_statement.executeLargeUpdate(sql, columnNames);
		}
	}
