...
/**
*/
public class BooksByAuthorQuery extends org.agileclick.genorm.runtime.SQLQuery
	{
	private static final Logger s_logger = LoggerFactory.getLogger(BooksByAuthorQuery.class.getName());
	
	public static final String QUERY_NAME = "books_by_author";
	public static final String QUERY = "select b.\"title\", b.\"isbn\" from author a, book b where a.\"name\" = ? and b.\"author\" = a.\"author_id\"";
	...
	//---------------------------------------------------------------------------
	public BooksByAuthorQuery(String name)
		{
		super();
		m_name = name;
		}
	...
	public String toString()
		...
		sb.append(" name=").append(String.valueOf(m_name));
	...
	public void serializeQuery(ContentHandler ch, String tagName)
		...
		while (rs.next())
			{
			BooksByAuthorData rec = rs.getRecord();
	...
	//---------------------------------------------------------------------------
	//Deprecated
	public ResultSet runQuery(String name)
		{
		try
			{
	...
	public ResultSet runQuery()
		...
		try
			...
			java.sql.PreparedStatement genorm_statement = GenOrmDataSource.prepareStatement(genorm_query);
			genorm_statement.setString(1, m_name);
	...
	public interface ResultSet extends GenOrmQueryResultSet
		{
		public List<BooksByAuthorData> getArrayList(int maxRows);
		public BooksByAuthorData getRecord();
		public BooksByAuthorData getOnlyRecord();
		}
	...
	private class SQLResultSet 
		...
		*/
		public List<BooksByAuthorData> getArrayList(int maxRows)
			{
			ArrayList<BooksByAuthorData> results = new ArrayList<BooksByAuthorData>();
			int count = 0;
			...
			try
				...
				if (m_onFirstResult)
					{
					count ++;
					results.add(new BooksByAuthorData(BooksByAuthorQuery.this, m_resultSet));
					}
		...
		*/
		public BooksByAuthorData getRecord()
			{
			BooksByAuthorData ret = null;
			try
				{
				ret = new BooksByAuthorData(BooksByAuthorQuery.this, m_resultSet);
				}
			catch (java.sql.SQLException sqle)
				{
				throw new GenOrmException(sqle);
		...
		*/
		public BooksByAuthorData getOnlyRecord()
			...
			try
				...
				if (m_resultSet.next())
					throw new GenOrmException("Multiple rows returned in call from BooksByAuthorQuery.ResultSet.getOnlyRecord");
				}
			catch (java.sql.SQLException sqle)
				{
				throw new GenOrmException(sqle);
	...
	public class Record extends GenOrmQueryRecord implements Attributes
		...
		protected Record(java.sql.ResultSet rs)
			...
			m_isbn = rs.getString(2);

			if (m_serializable)
				{
				m_attrValues = new String[ATTRIBUTE_COUNT];
				
				m_attrValues[0] = BooksByAuthorQuery.this.m_formatter.toString(s_attributeNames[0], m_title);
				m_attrValues[1] = BooksByAuthorQuery.this.m_formatter.toString(s_attributeNames[1], m_isbn);
